...
-- AlterTable
ALTER TABLE "DailyReport" ALTER COLUMN "startAt" SET DATA TYPE TIMESTAMPTZ(3),
...
-- AlterTable
ALTER TABLE "Setting" ALTER COLUMN "createdAt" SET DATA TYPE TIMESTAMPTZ(3),
ALTER COLUMN "updatedAt" SET DATA TYPE TIMESTAMPTZ(3);
...
-- AlterTable
ALTER TABLE "Work" ALTER COLUMN "startAt" SET DATA TYPE TIMESTAMPTZ(3),
ALTER COLUMN "endAt" SET DATA TYPE TIMESTAMPTZ(3),
ALTER COLUMN "createdAt" SET DATA TYPE TIMESTAMPTZ(3),
ALTER COLUMN "updatedAt" SET DATA TYPE TIMESTAMPTZ(3);
